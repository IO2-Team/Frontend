...
void main() {
  ...
  group('end-to-end test', () {
    ...
    testWidgets('Test Edit in Future Event', (tester) async {
      app.main();
      ...
      // Create event
      expect(find.text(infutureEventName), findsOneWidget);
      ...
      final Finder eventEndDateField = find.byKey(const Key('EventEndDateKey'));
